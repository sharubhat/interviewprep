...
/**
 * A husband and wife are trying to eat soup, but only have one spoon between them. Each spouse is
 * too polite, and will pass the spoon if the other has not yet eaten.
 */
